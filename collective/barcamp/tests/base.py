...
def setup_product():
    ...
    import collective.barcamp
    zcml.load_config('configure.zcml', collective.barcamp)
    ...
    ztc.installPackage('collective.barcamp')
...
setup_product()
ptc.setupPloneSite(products=['collective.barcamp'])
